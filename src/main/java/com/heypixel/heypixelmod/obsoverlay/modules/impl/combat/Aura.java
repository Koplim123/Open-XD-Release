    ...
    public void onMotion(EventRunTicks event) {
        if (event.getType() == EventType.PRE && mc.player != null) {
            ...
            if (aimingTarget != null) {
                this.rotationData = RotationUtils.getRotationDataToEntity(aimingTarget, "Center");
            ...
            if (targets.size() > 1
                ...
                for (int i = 0; i < targets.size(); i++) {
                    ...
                    RotationUtils.Data data = RotationUtils.getRotationDataToEntity(nextTarget, "Center");
